...
- selection: no filtered signals, selection yields no submitted trades
- pricing: flat filtered pnl, filled trades do not preserve positive modeled edge, captured edge is too small versus modeled edge
