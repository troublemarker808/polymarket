...
- close_out_quality_blockers: close_out_stop_out_pressure, close_out_negative_realized_pnl_bps
- profitability_tail_risk: review
- profitability_tail_risk_blockers: profitability_non_positive_pnl_per_notional, tail_loss_top3_concentration_breach
...
- route stage blocked: close_out_quality (close_out_stop_out_pressure, close_out_negative_realized_pnl_bps)
- route stage blocked: profitability_tail_risk (profitability_non_positive_pnl_per_notional, tail_loss_top3_concentration_breach)
