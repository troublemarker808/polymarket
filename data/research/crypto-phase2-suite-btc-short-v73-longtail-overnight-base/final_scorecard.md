...
- filter_order_delta: -78
- profit_focus: pricing
- secondary_profit_focus: selection
- loss_ranking: pricing, selection, sizing, execution, exit
...
- average_barrier_observed_gap_bps: 1157.6976
- average_surface_observed_gap_bps: 0.0000
- average_fusion_observed_gap_bps: 405.1942
- average_barrier_surface_disagreement_bps: 1157.6976
...
- design the next variant to also address secondary loss in selection instead of retuning pricing in isolation
...
- pricing: flat filtered pnl, selection currently loses pnl versus unfiltered replay, filled trades do not preserve positive modeled edge, captured edge is too small versus modeled edge, fused fair values remain far from observed pricing without enough realized capture, barrier and surface models disagree too much
