...
- loss_ranking: pricing, execution, sizing, exit, selection
...
- design the next variant to also address secondary loss in execution instead of retuning pricing in isolation
...
- execution: maker quotes expire before filling, moderate signal-to-order capture ratio
- exit: exit stable
