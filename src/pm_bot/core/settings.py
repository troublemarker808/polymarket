...
class TradingSettings(BaseModel):
    ...
    max_notional_per_exposure_group: float = Field(ge=0, default=1_000_000.0)
    max_notional_per_thesis_group: float = Field(ge=0, default=1_000_000.0)
    max_notional_per_underlying_group: float = Field(ge=0, default=1_000_000.0)
    max_notional_per_category: float = Field(ge=0, default=50.0)
    max_total_gross_notional: float = Field(ge=0, default=1_000_000.0)
