...
def _tracked_order_payload(order: object) -> dict[str, object]:
    ...
    return {
        ...
        "execution_route": getattr(order, "execution_route", None),
        "decision_reason": getattr(order, "decision_reason", None),
        "rationale_tags": list(getattr(order, "rationale_tags", ()) or ()),
